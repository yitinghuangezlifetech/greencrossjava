...
<body>
	...
	<section class="page-info-section set-bg" data-setbg="<c:url value = "../../img/green/page-info-bg/5.jpg"/>">
		<div class="container">
			<h2><c:choose><c:when test="${sessionScope.local == 'en'}">Eduation Infomation</c:when><c:otherwise>衛教資訊</c:otherwise></c:choose></h2>
		</div>
	</section>
										...
										<div class="form-group ">
											...
											<!--  
												<input type="text" class="input" name="title"
													value="${guardianDto.title}" style="width: 100%;" disable>
								...
								<!--div class="row">
									<div class="col-sm-12">
										<div class="form-group ">
											...
											<div class="col-sm-12">
											${guardianDto.contentEn} 
												<input type="text" class="input" name="content"
													value="${guardianDto.content}" style="width: 100%;" disable>
										...
										<div class="form-group ">
											...
											${guardianDto.contact}
												<input type="text" class="input" name="contact"
													value="${guardianDto.contact}" style="width: 100%;" disable>
										...
										<div class="form-group ">
											...
											${guardianDto.email}
												<input type="text" class="input" name="email"
													value="${guardianDto.email}" style="width: 100%;" disable>
										...
										<div class="form-group ">
											...
											${guardianDto.tel}
												<input type="text" class="input" name="tel"
													value="${guardianDto.tel}" style="width: 100%;" disable>
							...
							<form id="newsForm">
								<!--<div class="row">
									<div class="col-sm-12">
										<div class="form-group ">
											<div class="col-sm-12">
												<label for=proName>分類</label>
											</div>
											<div class="col-sm-12">
											${guardianDto.className}
											</div>
										</div>
									</div>
								</div>-->								
