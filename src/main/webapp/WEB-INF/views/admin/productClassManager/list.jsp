				...
				<form id="inputForm">
					...
					<div class='panel-body'>
						...
						<table class="table table-condensed">
							...
							<tr>
								<td><label for="classNameEn">商品分類名稱(英文)</label></td>
								<td><input type="text" id="classNameEn" class='input' name="classNameEn" value=""> 
								<font class='errText form-text' id='err_classNameEn' color='red'></font></td>
							</tr>
							<tr>
							...
							<tr>
								<td><label for="classDesc">商品分類描述</label></td>
								<td>
								<textarea id="classDesc" name="classDesc" rows="10" cols="30" style="height:440px" aria-label="editor"></textarea>
			
								
								<font class='errText form-text' id='err_classDesc' color='red'></font></td>
							</tr>
							<tr>
								<td><label for="classDescEn">商品分類描述(英文)</label></td>
								
								
								<td><textarea id="classDescEn" name="classDescEn" rows="10" cols="30" style="height:440px" aria-label="editor"></textarea></textarea>
								<font class='errText form-text' id='err_classDescEn' color='red'></font></td>
							</tr>						
						</table>
				...
				$.ajax({
					...
					success : function(result) {
						if (checkAjaxResp(result)) {
							...
							$('#classNameEn').val(result.data.classNameEn);
							$('#classParentId').val(result.data.classParentId);
							//$('#classDesc').val(result.data.classDesc);
							//$('#classDescEn').val(result.data.classDescEn);

							//$('#classDesc').html(htmlDecode(result.data.classDesc));
							var classDesc = $("#classDesc").data("kendoEditor");
							classDesc.value(htmlDecode(result.data.classDesc));

							var classDescEn = $("#classDescEn").data("kendoEditor");
							classDescEn.value(htmlDecode(result.data.classDescEn));
