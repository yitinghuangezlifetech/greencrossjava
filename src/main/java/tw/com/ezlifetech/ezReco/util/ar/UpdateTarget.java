 ...
 * @author PaulChen
 */
public class UpdateTarget extends AbstractOperateTargetExecution {
	...
	UpdateTarget(String accessKey, String secretKey, String imagePath, String imageNm , String targetId) {
	...
	UpdateTarget(String accessKey, String secretKey, String imagePath, String imageNm ,String metaData, String targetId) {
		super(accessKey, secretKey);
	...
	protected HttpUriRequest getRequest(String url) {
		...
		try {
			...
			put.setEntity(new StringEntity(reqBodyJsonStr));
