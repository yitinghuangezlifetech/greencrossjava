...
public class GuardianPicDto extends CommonDto{
	public static final String dtoName = "guardianPicDto";
	...
	public GuardianPicDto() {
		
	}
	
	public GuardianPicDto(GuardianPic guardianPic) {
		BeanUtils.copyProperties(guardianPic, this);
	}
