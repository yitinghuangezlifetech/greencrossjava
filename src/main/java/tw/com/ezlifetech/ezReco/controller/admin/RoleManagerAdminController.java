...
@Controller
@RequestMapping("/admin/roleManagerAdmin")
public class RoleManagerAdminController extends GenericController {
	private static final String JAVA_NAME="RoleManagerAdminController";
	private static Logger logger = LoggerFactory.getLogger(RoleManagerAdminController.class);
	@Autowired
	private RoleManagerAdminService roleManagerService;

	@RequestMapping("/roleList")
	public String roleList(Model model, @ModelAttribute(RoleManagerBean.beanFormName) RoleManagerBean formBean) {

		return "admin/roleManagerAdmin/list";
	}
	...
	public String funcRoleList(Model model, @ModelAttribute(RoleDto.dtoName) RoleDto dto) {
		...
		return "admin/roleManagerAdmin/funcList";
	}
	...
	public @ResponseBody String ajaxRoleGridList(RoleManagerBean formBean, HttpServletRequest request) {
		...
		return roleManagerService.roleGridList(formBean);
	}
	...
	public @ResponseBody String ajaxRoleFunGridList(RoleDto dto, HttpServletRequest request) {
		...
		return roleManagerService.roleFunGridList(dto);
	}
