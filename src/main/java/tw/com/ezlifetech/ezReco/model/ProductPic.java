...
/**
 * ProductPic generated by hbm2java
 */
@Entity
@Table(name = "product_pic", schema = "public")
public class ProductPic extends GenericEntity<String> {
	...
	public ProductPic(String id, String proNo, String picPatch) {
		this.id = id;
		this.proNo = proNo;
