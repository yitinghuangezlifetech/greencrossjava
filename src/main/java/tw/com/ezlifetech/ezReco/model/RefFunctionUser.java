...
/**
 * RefFunctionUser generated by hbm2java
 */
@Entity
@Table(name = "ref_function_user", schema = "public", uniqueConstraints = @UniqueConstraint(columnNames = { "func_no",
		"user_id" }))
public class RefFunctionUser extends GenericEntity<String> {
	...
	public RefFunctionUser() {
	}

	public RefFunctionUser(String id, String funcNo, String userId, String authority) {
		this.id = id;
		this.funcNo = funcNo;
		this.userId = userId;
