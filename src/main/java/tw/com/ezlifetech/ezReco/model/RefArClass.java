 ...
 */
@Entity
@Table(name = "ref_ar_class", schema = "public", uniqueConstraints = @UniqueConstraint(columnNames = { "ar_no",
		"class_serno" }))
public class RefArClass extends GenericEntity<String> {
	...
	public RefArClass(String id, String arNo, String classSerno, String createUser, Date createTime) {
		this.id = id;
		this.arNo = arNo;
	...
	@Column(name = "ar_no", nullable = false, length = 20)
